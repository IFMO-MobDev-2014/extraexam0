...
public class BuildProvider extends ContentProvider {
    private static final String TAG = BuildProvider.class.getSimpleName();
    ...
    public static final String AUTHORITY = "ru.ifmo.md.extraexam0.provider";
    public static final String CONTENT_URI_BASE = "content://" + AUTHORITY;

    public static final String QUERY_NOTIFY = "QUERY_NOTIFY";
    public static final String QUERY_GROUP_BY = "QUERY_GROUP_BY";

    private static final int URI_TYPE_BUILD = 0;
    private static final int URI_TYPE_BUILD_ID = 1;
    ...
    static {
        URI_MATCHER.addURI(AUTHORITY, BuildColumns.TABLE_NAME, URI_TYPE_BUILD);
        URI_MATCHER.addURI(AUTHORITY, BuildColumns.TABLE_NAME + "/#", URI_TYPE_BUILD_ID);
    }

    protected MySQLiteOpenHelper mSQLiteOpenHelperMy;
    ...
    public boolean onCreate() {
        ...
        mSQLiteOpenHelperMy = MySQLiteOpenHelper.getInstance(getContext());
        return true;
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case URI_TYPE_BUILD:
                return TYPE_CURSOR_DIR + BuildColumns.TABLE_NAME;
            case URI_TYPE_BUILD_ID:
                return TYPE_CURSOR_ITEM + BuildColumns.TABLE_NAME;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long rowId = mSQLiteOpenHelperMy.getWritableDatabase().insertOrThrow(table, null, values);
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        String table = uri.getLastPathSegment();
        SQLiteDatabase db = mSQLiteOpenHelperMy.getWritableDatabase();
        int res = 0;
        db.beginTransaction();
        try {
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int res = mSQLiteOpenHelperMy.getWritableDatabase().update(queryParams.table, values, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        QueryParams queryParams = getQueryParams(uri, selection, null);
        int res = mSQLiteOpenHelperMy.getWritableDatabase().delete(queryParams.table, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        Cursor res = mSQLiteOpenHelperMy.getReadableDatabase().query(queryParams.tablesWithJoins, projection, queryParams.selection, selectionArgs, groupBy,
    ...
    private QueryParams getQueryParams(Uri uri, String selection, String[] projection) {
        ...
        switch (matchedId) {
            case URI_TYPE_BUILD:
            case URI_TYPE_BUILD_ID:
                res.table = BuildColumns.TABLE_NAME;
                res.tablesWithJoins = BuildColumns.TABLE_NAME;
                res.orderBy = BuildColumns.DEFAULT_ORDER;
                break;
