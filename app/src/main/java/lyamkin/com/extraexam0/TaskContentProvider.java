...
public class TaskContentProvider extends ContentProvider {
        ...
        public static final Uri CHANNELS_URI = Uri.parse("content://lyamkin.com.extraexam0.tasks/channels");
        public static final Uri NEWS_URI = Uri.parse("content://lyamkin.com.extraexam0.tasks/news");

        private static final UriMatcher matcher = new UriMatcher(UriMatcher.NO_MATCH);
        static {
            matcher.addURI("lyamkin.com.extraexam0.tasks", "channels", CHANNELS);
            matcher.addURI("lyamkin.com.extraexam0.tasks", "news/#", NEWS);
        }
